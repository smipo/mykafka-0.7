...
public class ProducerRequest extends Request {
    ...
    String topic;
    int partition;
    kafka.javaapi.message.ByteBufferMessageSet messages;

    public ProducerRequest(String topic, int partition, kafka.javaapi.message.ByteBufferMessageSet messages) {
